  ...
  return (
    <div className='relative mx-auto w-full max-w-pc px-3 lg:px-0'>
      <div className='my-5 flex flex-col text-center lg:mx-auto lg:my-10 lg:gap-1'>
        <h1 className='bg-clip-text text-2xl font-bold text-gray-800 lg:h-[56px] lg:text-5xl'>{t('title')}</h1>
        <h2 className='text-balance text-xs font-semibold text-gray-600 lg:text-sm'>{t('subTitle')}</h2>
      </div>
