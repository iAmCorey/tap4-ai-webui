    ...
    <div className='relative w-full'>
      <div className='relative mx-auto w-full max-w-pc flex-1 px-3 lg:px-0'>
        <div className='my-5 flex flex-col text-center lg:mx-auto lg:my-10 lg:gap-1'>
          <h1 className='pb-4 pt-4 text-5xl font-bold text-gray-900 lg:text-5xl'>{t('title')}</h1>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <Link
            href='/explore'
            className='mx-auto mb-10 mt-10 flex w-fit items-center justify-center gap-5 rounded-[9px] border border-gray-600 p-[10px] text-sm leading-4 hover:border-white hover:bg-orange-400 hover:text-white hover:opacity-70'
          >
            {t('exploreMore')}
